...
import { convertRoomResponse, convertRoomTypesData, createSecretToken1, decode } from '../common/commonFunctions';
...
export const getresourcecategories = createAction({
  ...
  async run(context) {
    ...
    const roomsResponse = await getRooms(roomsEndpoint, creds["Login"], pwd, hotelId);
