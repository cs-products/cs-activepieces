...
export const transformUpdateRequest = (requestBody:any, requiredParams:any, optionalParams:any) => {
  ...
  const valuesToBeUpdatedWithObj = ["Name", "MotherCompanyId", "InvoiceDueInterval", "ContactPerson", "Contact", "Notes", "Iata", "Department", "DunsNumber", "ExternalIdentifier", "ReferenceIdentifier", "WebsiteUrl", "Telephone"]
